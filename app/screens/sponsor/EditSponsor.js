...
const SPONSOREDIT_URL = 'http://kamilla-server.000webhostapp.com/app/sponsor/editSponsorProfile.php';
const CITIES_URL = 'http://kamilla-server.000webhostapp.com/app/getCities.php';

class EditSponsor extends Component {
    static navigationOptions = {
      title: 'Rediger Sponsor',
      headerTitleStyle: {
          color: 'white',
        },
        headerStyle: {
    ...
    async onEditSponsor() {
        const { sponsorName, sponsorEmail, address, postalCode, city, phone, website, logoBase64 } = this.state;

        const responose = await fetch(SPONSOREDIT_URL, {
          headers: {
              Accept: 'application/json',
              'Content-Type': 'application/json'
          },
          method: 'POST',
          body: JSON.stringify({ sponsorName, sponsorEmail, address, postalCode, city, phone, website, logoBase64 }),
        })
        ...
        return(
          <KeyboardAwareScrollView contentContainerStyle={styles.container}>
              <View style={styles.area}> 
                  ...
                  <TextInput
                      defaultValue={sponsorData.SponsorName}
                  ...
                  <Text>Email</Text>
                  <TextInput
                      defaultValue={sponsorData.SponsorEmail}
                  ...
                  <Text>Adresse</Text>
                  <TextInput
                      defaultValue={sponsorData.Address}
                  ...
                  <TouchableOpacity 
                      ...
                      <TextInput
                          defaultValue={sponsorData.PostalCode, sponsorData.City}
                          keyboardType='default'
                          style={styles.input}
                          editable={false}
                          pointerEvents='none'
                  ...
                  <Text>Telefon</Text>
                  <TextInput
                      defaultValue={sponsorData.Phone}
                  ...
                  <TextInput
                      defaultValue={sponsorData.Website}
                  ...
                  <Button 
                      ...
                      onPress={this.onEditSponsor.bind(this)}
                  />
