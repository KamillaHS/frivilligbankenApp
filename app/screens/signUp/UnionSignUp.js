...
class UnionSignUp extends Component {
    ...
    async onMakeUnion() {
        var { apiData, cvr, unionName, unionEmail, address, postalCode, city, phone, website, description, logo } = this.state;
        ...
        if(this.state.description != '') {
            const responose = await fetch(UNIONSIGNUP_URL, {
                ...
                method: 'POST',
                body: JSON.stringify({ cvr, unionName, unionEmail, address, postalCode, city, phone, website, description, logo }),
            })
